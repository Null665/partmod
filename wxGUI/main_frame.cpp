...
MainFrame::MainFrame(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	ButtonSaveChanges = new wxButton(Panel1, ID_BUTTON1, _(" Save changes "), wxPoint(328,392), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON1"));
	ButtonQuit = new wxButton(Panel1, ID_BUTTON2, _("Quit"), wxPoint(336,424), wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON2"));
	...
	MenuCreateBackup = new wxMenuItem(menuDisk, ID_CREATE_BACKUP, _("Create partition table backup..."), _("Create a backup of the partition table structure"), wxITEM_NORMAL);
	menuDisk->Append(MenuCreateBackup);
	MenuRestoreBackup = new wxMenuItem(menuDisk, ID_RESTORE_BACKUP, _("Restore partition table..."), _("Restore partition table from backup"), wxITEM_NORMAL);
